...
/**
 * Created by karikari on 7/20/16.
 */
...
public class VolleyRequests {
    ...
    /*public void JsonObjRequestDownload(String url, final int id, final String url2, final PaginateCallBack callBack) {
        callBack.onStart();
        Log.d(TAG, "Outer Url :"+url);
        JsonObjectRequest jsObjRequest = new JsonObjectRequest
                (Request.Method.GET, url, null, new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            int pages = response.getInt("total_pages");

                            for (int i = 1; i <= pages; i++) {
                                callBack.onProgress(i);
                                Log.d(TAG, "Inner Url :"+GenUtils.getFormatUrl(url2,i,id));

                                JsonObjectRequest jsonRequest = new JsonObjectRequest(
                                        Request.Method.GET, GenUtils.getFormatUrl(url2,i,id), null, new Response.Listener<JSONObject>() {
                                    @Override
                                    public void onResponse(JSONObject object) {
                                        //Log.d(TAG, "Result from Server :"+object.toString());
    ...
    public void JsonObjRequestDownload(String url, final String id, final String url2, final PaginateCallBack callBack) {
        callBack.onStart();
        Log.d(TAG, "Outer Url :"+url);
        JsonObjectRequest jsObjRequest = new JsonObjectRequest
                (Request.Method.GET, url, null, new Response.Listener<JSONObject>() {
